...
import br.jus.tre_pa.datafilter.domain.FooType;
import br.jus.tre_pa.datafilter.predicate.Conjunction;
import br.jus.tre_pa.datafilter.predicate.EqualsPredicate;
import br.jus.tre_pa.datafilter.repository.specification.FooSpecification;

@RunWith(SpringRunner.class)
@DataJpaTest
@SpringBootTest(classes = { JiiCoreAppTest.class, FooSpecification.class })
